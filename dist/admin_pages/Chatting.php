...
$sql = "SELECT user_id, first_name, last_name, email, phone_number, password_hash, degree, country FROM users";
...
<body>
  ...
  <section class="home-section">
    <iframe src="https://web.whatsapp.com/" title="WhatsApp Web"></iframe>
  </section>
